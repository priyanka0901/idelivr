...
bannerboy.main = function() {
	...
	bannerboy.preloadImages(images, function() {
		...
		var txt_1 = bannerboy.createElement({left: 408, top: 8, width: 234, height: 74, parent: banner});
			var txt_1_2 = bannerboy.createElement({backgroundImage: "txt_1_2.png", left: 1, top: 17, retina: true, parent: txt_1});
